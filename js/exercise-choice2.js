...
(function () {
  ...
  function renderExercise(container, rows, setNumber, allSets, availableLevels, requestedLevel) {
    ...
    checkBtn.addEventListener('click', () => {
      ...
      // Comprobar only colors right/wrong (immediate) — which option was
      // actually correct stays hidden (.solution-hidden, in styles.css)
      // until Mostrar solución is clicked, so a wrong answer can still be
